...
namespace EskiDefterler.MVC.Models.ViewModels.Account
{
    public class UserInsertVM
    {
        ...
        [StringLength(11, ErrorMessage ="Phone number should be 11 char")]
        [RegularExpression("^[0-9]{11}$",ErrorMessage ="Phone number contianed between 0-9 only.")]
        [DataType(DataType.PhoneNumber)]
        public string Phone {  get; set; }

        [Required(ErrorMessage ="Address is mandatory")]
        [StringLength(300,ErrorMessage ="300 char")]
